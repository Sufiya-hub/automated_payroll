...
const Features = () => {
  return (
    <div className="flex flex-col gap-6 px-8 py-14 h-[100vh]">
      <div className="flex flex-col gap-2">
        <h1 className="font-semibold text-3xl">Effortless Payroll</h1>
        <p className="w-[60ch] font-light text-sm">
            ...
            <div className="flex flex-col hover:shadow-md transition-all bg-white rounded-xl p-4 gap-10  ">
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="font-light text-sm w-[45ch]">
                    Simply payroll with automated calculations,ensuring accurate
                    payments and compliance every time.
                  </p>
                </div>
              </div>
              <div className="border-2 rounded-2xl cursor-pointer font-medium flex justify-between items-center px-4">
                <button className="py-1">Learn more</button>
                <FaArrowRight />
              </div>
            </div>
