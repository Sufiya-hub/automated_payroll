    ...
    <div className="flex flex-col justify-between gap-8 p-8 w-[35ch] bg-background h-[100vh]">
      <div className="flex flex-col gap-8 ">
        {SIDEBAR.map((object, obkey) => (
          <div key={obkey}>
            <h1
              className={`font-semibold text-2xl  text-brand  ${object.styles}`}
            >
              {object.heading}
            </h1>
      ...
      <button
        type="button"
        onClick={signOut}
        className=" bg-red-500 flex gap-2 items-center font-bold text-white px-3 py-2 rounded-lg  shadow-md hover:bg-red-700 transition-all self-start"
      >
